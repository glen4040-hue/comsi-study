...
const ANSWER_DATA={...(window.ANSWERS_131||{}),...(window.ANSWERS_132||{}),...(window.ANSWERS_134||{}),...(window.ANSWERS_135||{})};
...
if('serviceWorker'in navigator&&location.protocol!=='file:')navigator.serviceWorker.register('sw.js?v=156');
